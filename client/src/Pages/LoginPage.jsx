...
import { Form, Input, Button, Row, Col, Typography, Spin, Avatar } from "antd";
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (response.ok) {
        ...
        const { role, name, user } = responseData;
  ...
  return (
    <Row justify="center" align="middle" style={{ minHeight: "100vh" }}>
      <Col span={8} style={formContainerStyle}>
        {/* <center>   <Avatar size={64} icon={<UserOutlined />} style={{ marginBottom: "20px",height:"100px",width:"100px",marginTop:'20px' }} /> </center> */}
        ...
        <Form form={form} onFinish={handleSubmit} layout="vertical">
          ...
          <center> <Form.Item>
            <a href="*" style={{ color: "#9900ff", marginBottom: "10px" }}>
              Forgot Password?
            </a>
          </Form.Item> </center>
